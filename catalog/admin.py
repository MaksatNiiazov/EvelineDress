...
from catalog.models import Product, Size, Color, Variant, VariantMedia, Characteristic
...
class ProductAdmin(NestedModelAdmin):
    ...
    fieldsets = [
        ('Main Information', {'fields': ['name', 'is_new', 'is_top', 'description', 'price_kgs', 'price_kzt',
